...
export default function SuccessBanner({ title = "Éxito", message, onClose }) {
  return (
    <div className="fixed top-6 right-6 z-50 bg-white border-l-8 border-green-400 shadow-xl rounded-2xl w-[320px] p-5 text-gray-800">
